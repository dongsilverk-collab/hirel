...
【점수 규칙】
반드시 4개 세부 점수(scores의 experienceMatch, cultureFit, skillKeywords, stability)를 모두 0이 아닌 실제 평가값(1~100점)으로 채우세요. 0점은 허용하지 않습니다.
totalScore는 4개 점수의 가중 평균이어야 하며, 각 점수와 일관성 있게 작성하세요.
...
{"totalScore":85,"scores":{"experienceMatch":80,"cultureFit":75,"skillKeywords":85,"stability":90},"verdict":"추천","strengths":["강점1","강점2","강점3"],"weaknesses":["약점1","약점2"],"keywords":[{"word":"키워드","type":"positive"}],"interviewQuestions":{"culture":["질문1","질문2","질문3"],"skill":["질문1","질문2","질문3","질문4","질문5"],"future":["질문1","질문2"],"killpath":["질문1","질문2","질문3"],"growth":["질문1","질문2"],"dataSkill":["질문1","질문2","질문3"],"execution":["질문1","질문2"]},"summary":"요약"}`;
