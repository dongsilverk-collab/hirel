...
const KIT_QUESTIONS = {
  ...
  "박현철": [
    ...
    { text: "(08.21 추가) 이전 회사들의 팀 구성 인원과 업무 비중을 말씀해 주세요 — 그중 본인이 '직접' 한 일과 팀원에게 맡긴 일을 나눠서요.", pass: "직접/위임을 솔직하게 분리하고 직접 수행 비중을 구체적 사례로 증명", red: "경력기술서처럼 전부 본인이 한 것처럼 말함 / 분리를 못함 — 범위가 넓은 이력서의 실체 검증" },
    { text: "(08.21 추가) 지금 큐라엘 브랜드에 가장 필요한 마케팅 전략이 뭐라고 보세요?", pass: "자사몰·채널·타깃을 사전 조사한 흔적 + 커머스 이해 기반의 구체 제안", red: "어느 회사에나 통하는 일반론" },
    { text: "(08.21 추가) 온라인-오프라인 연계 마케팅 경험을 성과와 함께 말씀해 주세요.", pass: "플레이스·체험단·OOH·행사 등 실사례를 수치·역할과 함께", red: "채널 나열만 하고 본인 역할·성과 없음" },
    { text: "(08.21 추가) 식품 아이템으로 성과가 좋았던 사례가 있나요? 건기식 경험이 많지 않아 보이는데 그 갭은 어떻게 메우실 건가요?", pass: "인접 경험(헬스케어·홍삼)을 연결하고 심의·규제 학습 계획을 구체적으로", red: "'식품도 마케팅은 다 똑같다' 식 안일함" },
    { text: "(08.21 추가) 처음엔 팀원 0명 실무부터 시작해서, 성과를 내면 마케팅 조직을 직접 세팅해 팀장으로 가는 그림입니다 — 이 여정을 갈 의사가 있으신가요? 큐라엘에서 3년 뒤 본인의 목표는요?", pass: "실무 선행을 수용하고 조직 세팅 로드맵·장기 목표를 구체적으로 (팀장 이직 시 팀 흔들림을 아는 답변)", red: "빠른 관리자 복귀 기대 / 목표가 모호 — 중심 못 잡으면 조직 세팅 후 이탈 리스크" },
    { text: "(08.21 추가) 업무 프로세스를 어떤 스타일로 진행하시나요? 기획→실행→보고 흐름으로 말씀해 주세요.", pass: "데이터 기반 의사결정·주기적 공유 등 구체적 루틴", red: "추상적('소통을 중시') / 보고 없는 단독 진행 스타일" },
    { text: "(08.21 추가) 나중에 팀을 만든다면 가장 먼저 뽑을 팀원은 어떤 경력의 사람인가요?", pass: "큐라엘 상황(소재 제작 공백 등)에 맞춘 역할 설계 — 조직 설계 역량의 증거", red: "일반론 / 본인과 같은 관리형만 찾음" },
    { text: "🔁(2차 최초반) 커피챗에서 '1인 스페셜리스트로 밥값 할 자신이 없어졌다'고 솔직히 말씀하셨죠. 다시 지원하신 이유 — 그때와 뭐가 달라졌나요?", pass: "구체적 재평가 근거(역할 이해·본인 강점 재정의) — 도피가 아닌 선택", red: "YQ 상황 악화로 인한 도피성 복귀 / 그때 발언을 부정하거나 얼버무림" },
    { text: "🔁(2차) YQ는 지금 어떤 상태인가요? (지난번 이직 1개월차였음 — 재직/퇴사, 사유)", pass: "상태·사유를 투명하게", red: "말 바꿈 / 불투명" },
    { text: "🔁(2차·조건) 지난 커피챗에서 연봉 7,000 이야기가 있었습니다. 저희 공식 레인지를 다시 말씀드립니다: [면접 전 대표 확정 숫자]. 이 조건으로도 오시겠습니까?", pass: "명확한 수용 + 이유", red: "'그때 100억이면 7천 주신다 했잖아요' — 커피챗 발언 소환 시 '조건부 담소였고 공식 조건은 이것'으로 정리" },
    { text: "🔁(2차·실행 전환) 커피챗에서 관능 허들은 퍼포먼스가 아니라 콘텐츠·체험·팬덤·레퍼럴로 풀어야 한다고 하셨죠. 입사한다면 그 제안을 첫 90일 실행안으로 지금 걸어가 주세요 — 주차별로.", pass: "훈수가 실행 계획으로 전환됨(리소스·순서·지표 포함)", red: "지난번 수준의 방향론 반복 — 그러면 '좋은 자문, 부적합한 실무자' 확정" },
  ],
  "이찬우": [
  ...
  "정유철": [
    { text: "(최초반 선고지) 저희 상한은 5,500입니다. 직전 7,000이셨고 희망을 6~7천으로 적으셨는데, 이 레인지에서도 이 자리가 의미 있나요?", pass: "수용 + 이유가 구체적(실무 복귀·카테고리 관심·구직 상황의 솔직한 인정)", red: "'일단 들어가서 조정' 뉘앙스 → 정중히 조기 종료 (연봉 앵커 올리는 발언 금지)" },
    { text: "동일제약을 올해 2월에 나오셨는데 — 퇴사 사유와 이후 6개월은 어떻게 보내셨나요?", pass: "사유가 구체적·일관, 공백기 활동을 실물로 설명", red: "회사 탓 반복 / 공백 설명이 추상적" },
    { text: "COSWORKER 매출 0→연 5억, ROAS 420% — 기획·디자인·매체 운영 중 본인이 '직접 손으로' 한 부분을 분리해 주세요. 가장 최근에 본인이 직접 세팅한 캠페인은 언제였나요?", pass: "직접/지시를 솔직하게 분리 + 최근 3개월 내 직접 세팅을 캠페인 구조 수준으로", red: "전부 본인이 한 것처럼 말함 / 직접 세팅이 1년 이상 전" },
    { text: "14개 제품 소재 A/B 테스트 프로세스를 처음부터 걸어가 주세요. 저희 베지셀(암 환우용 식품)이면 첫 소재 3안을 어떤 소구로 잡겠어요?", pass: "테스트 설계가 구체적 + 즉석 적용에서 타깃 감수성이 보임", red: "일반론 / 공포 소구·효능 과장으로 감" },
    { text: "스킨케어는 화장품 표시광고 영역이었는데, 건강기능식품 심의와의 차이를 아시나요? '암 환자의 회복을 돕는다'는 표현은 쓸 수 있을까요?", pass: "차이 인지 + 못 쓰는 이유와 대체 접근을 말함", red: "'마케팅은 다 똑같다' / 심의 개념 없음" },
    { text: "유니박 8개월, 웨이크 8개월 — 각각 짧았던 이유를 따로 말씀해 주세요.", pass: "남 탓 없는 개별 사유 + 패턴 자각", red: "매번 회사 탓 / 얼버무림" },
    { text: "8년째 팀장 직함인데, 저희는 팀원 0명 실무 자리로 시작합니다. 본인의 하루가 어떨 것 같고, 3년 뒤 그림은요?", pass: "실무 선행을 구체적 하루 일과로 수용 + 성과→조직 세팅 로드맵", red: "빠른 관리자 복귀 기대 / 실무 디테일이 안 나옴" },
  ],
  "왕태일": [
    { text: "(최초반 정렬) 저희 실무 포지션 상한은 5,500입니다. 희망 8,700과 갭이 큰데 — 어떤 형태의 협업이면 서로에게 의미가 있을까요?", pass: "갭을 현실로 인정하고 구조(역할 범위·성과 연동·자문형 등)를 함께 탐색", red: "막연히 '맞춰보겠다' / 입사 후 조정 기대 (즉석 연봉 약속 금지)" },
    { text: "18년 중 최근 10년이 본부장·총괄이신데, 최근 6개월 안에 본인 손으로 직접 세팅한 광고 캠페인이나 직접 만든 소재가 있나요?", pass: "GRILL X 등에서 직접 세팅한 실물을 구조 수준으로 설명", red: "팀 성과를 본인 것처럼 / '방향을 잡는 게 제 역할' 회피" },
    { text: "GRILL X에서 월 400건 리드 — Demand Gen·PMAX 캠페인 구조와 리드 품질 관리를 걸어가 주세요.", pass: "세팅·지표·개선이 한 흐름(직접 운영의 증거)", red: "지표 나열만 / 구조 질문에 추상적" },
    { text: "도드람 캔돈은 제품 개발 PM부터 하셨죠. 큐라엘이 연매출 100억을 목표로 한다면 무엇부터 하시겠어요?", pass: "우리 채널·제품을 사전 조사한 흔적 + 실행 순서가 구체적", red: "어느 회사에나 통하는 일반론 / 훈수만 두고 본인 실행 없음" },
    { text: "대상웰라이프 아르포텐 컨설팅 때 건기식 심의·표시광고에서 실제 부딪힌 사례가 있나요?", pass: "실사례 + 규제 안에서의 대체 접근", red: "컨설팅 수준 일반론뿐" },
    { text: "비욘드허니컴 4개월째인데 움직이시는 이유는요? 2023년 7개월, 창업 1년 3개월 — 이 리듬을 어떻게 설명하세요?", pass: "패턴 자각 + 개별 사유가 납득됨", red: "회사 탓 반복 / 자각 없음" },
    { text: "저희는 마케터가 0명입니다. 본부장이 아니라 '첫 번째 실무자'가 되어야 하는데, 합류한다면 본인의 하루가 어떨 것 같으세요?", pass: "소재 제작·매체 세팅이 들어간 실무의 하루를 그림", red: "조직 만들 이야기부터 시작 / 실무 디테일 없음" },
  ],
  "이시라": [
    { text: "(조건 확인 — 짧게) 희망 5,500으로 적어주셨고 저희 레인지와 일치합니다. 연봉 외에 이 자리에서 기대하시는 게 뭔가요?", pass: "역할·성장·카테고리 관심이 구체적", red: "조건 재협상 시도 / 기대가 모호 (※ 즉석 인상 발언 금지 — 갭 없음)" },
    { text: "블렌디드에서 4년 5개월 — 잘 다니시던 회사를 올해 7월에 나오신 이유는요?", pass: "납득 가능한 사유(역할 정체·회사 변화 등)를 남 탓 없이", red: "얼버무림 / 사유와 시점이 안 맞음" },
    { text: "월 최대 2.7억 예산 운영 — 대표 캠페인 하나를 세팅부터 걸어가 주세요. 캠페인 구조·타깃·소재 교체 기준까지. 그 세팅은 본인 손이었나요, 팀 분업이었나요?", pass: "직접 세팅을 구조 수준으로 + 직접/분업을 솔직히 분리", red: "지표 나열만 / '팀이 했다'로 뭉개짐" },
    { text: "코어뉴트리션 액상 비오틴 — 시장조사부터 출시까지 E2E라고 하셨는데, 그중 본인이 직접 만든 것과 협업으로 된 것을 나눠 주세요.", pass: "기여 분리 명확 + 의사결정 근거 설명", red: "전부 본인 성과처럼" },
    { text: "저희 고객은 암 환우와 가족입니다. 베지셀(야채주스) 첫 소재 3안을 즉석에서 잡는다면 어떤 소구로 가시겠어요? 건기식과 일반식품의 표현 차이는요?", pass: "감수성 있는 소구 + 심의 차이 인지", red: "공포 소구·효능 단정 / 차이 모름" },
    { text: "블렌디드에 방주환님이라고 계시죠 — 같이 일해보셨나요? 그 조직에서 배운 것과 아쉬웠던 것 하나씩요.", pass: "자연스러운 조직 이야기(교차 검증 데이터 확보)", red: "회피 / 험담" },
    { text: "저희는 마케팅 0~2명의 소수 조직이고, 3개월 기대치를 입사 첫날 문서로 드립니다. 3년 뒤 어떤 모습이면 성공한 이직일까요?", pass: "우리 구조에서 실현 가능한 그림", red: "모호 / 대기업 복귀형" },
  ],
  "김남수": [
    { text: "(최초반 선고지) 희망을 9,500으로 적어주셨습니다. 저희 총괄 자리 예산 레인지는 [면접 전 대표 확정]이고, 구체 숫자는 서면 오퍼로 드립니다. 기본급+성과 연동 구조라면 어떤 형태가 서로 의미 있을까요?", pass: "갭을 인정하고 구조(성과 연동·마일스톤)를 함께 설계하려 함", red: "고정 9,500 고수 / 모호한 '맞춰보겠다' (※ 즉석 수락·앵커 상향 절대 금지)" },
    { text: "교동식품 자사몰 — 오픈 3개월에 월 400만→3억을 만드셨는데, 그 첫 30일을 일 단위로 걸어가 주세요. 본인이 직접 한 것과 15명에게 시킨 것을 나눠서요.", pass: "직접/지시 분리가 구체적(계정 세팅·소재·상세 등 실물), 숫자의 구성(객단가·주문수) 설명 가능", red: "총괄 관점 요약만 반복 / 숫자 구성 설명 못 함" },
    { text: "심의 메시지 매트릭스 — 그 프레임을 지금 화이트보드에 그려주시고, 저희 카테고리에 적용해 보죠: '암 환자의 회복을 돕는다'는 메시지, 어디까지 가능하고 어떻게 우회합니까?", pass: "매트릭스가 실물로 나옴 + 즉석 적용에서 문제 언어/심의 언어 분리를 시연", red: "개념 설명만 / 즉석 적용 실패" },
    { text: "교보에서 만든 진단→상담→계약 퍼널 — 저희는 상담약국(35만원 유료 상담, 3천 명 데이터)이 이미 있습니다. 이식한다면 첫 분기에 무엇부터 만드시겠어요?", pass: "우리 구조를 사전 조사한 흔적 + 실행 순서·지표 구체적", red: "교보 사례 재설명에 그침" },
    { text: "창업 4년 반 하시고 정리하셨죠. '본업이 잘될 때가 가장 위험하다'고 쓰셨는데 — 저희가 지금 40억에서 100억을 가려는 국면입니다. 그 원칙대로면 저희가 지금 하지 말아야 할 게 뭡니까?", pass: "우리 상황에 맞는 구체적 경계(검증 전 확장 등) — 판단력의 증거", red: "일반론 / 아부성 답변" },
    { text: "파워풀엑스 5개월은 왜 짧았고, 교보 희망퇴직의 경위는요?", pass: "투명한 사유(스카우트 이동·구조개편) + 일관성", red: "얼버무림" },
    { text: "Claude Code·Codex 자동화 파이프라인을 직접 운영하신다고요 — 실제로 뭘 자동화했고, 저희(상무가 Claude 맥스 운영 중)에 오시면 첫 달에 뭘 자동화하시겠어요?", pass: "실물 사례 + 우리 적용안 구체적", red: "툴 이름 나열" },
  ],
  "황유정": [
    { text: "(최초반 선고지) 현재 4,999에 희망은 '협의'로 적어주셨습니다. 저희 실무 포지션 레인지는 상한 5,500입니다 — 이 레인지면 협의가 되실까요?", pass: "레인지를 수용하고 역할 이야기로 넘어감", red: "숫자를 흐리며 '가서 보고' / 기대치가 레인지 위 (※ 즉석 인상 발언 금지)" },
    { text: "에이치데일리 1년 7개월 재직 중이신데 이직을 보시는 이유가 '경영환경 변화'라고요 — 구체적으로 어떤 상황인가요?", pass: "구체적 상황(구조조정 조짐·방향 전환 등)을 남 탓 없이 설명", red: "얼버무림 / 직전 3개사(폐업·팀해체·계약만료)와 묶어 전부 외부 탓" },
    { text: "생성형 AI 숏폼 제작 프로세스를 '구축'하셨다고요 — 어떤 도구로, 기획부터 업로드까지 몇 단계인지, 지금 화이트보드에 걸어가 주세요. 주 몇 편이 나옵니까?", pass: "도구·단계·산출량이 실물로 나옴(프로세스를 만든 사람의 디테일)", red: "'AI 활용했다' 수준의 개념 설명 / 산출량 답 못 함" },
    { text: "Meta 광고는 세팅부터 본인 손인가요? 에이치데일리에서 월 광고비 규모가 얼마였고, 텍스트형·ASMR형·인물형·후기형 중 어떤 포맷이 CTR이 제일 잘 나왔나요?", pass: "직접 세팅 + 예산 규모·포맷별 성과를 숫자로", red: "대행 관리였음이 드러남 / 포맷 비교 답 못 함" },
    { text: "광주요 자사몰 ROAS 1,000%+ — 그 숫자의 구성을 뜯어봐 주세요. 브랜드 검색 비중은요? 신규 고객만 보면 얼마였을까요?", pass: "숫자의 한계(브랜드 지명검색·재구매 포함 여부)를 스스로 분리", red: "구성 설명 못 하고 숫자만 반복" },
    { text: "톡스핏·레몬애사비 같은 건강식품을 하셨으니 — 저희 고객은 암 환우와 가족입니다. '혈당 잡아주는'식 표현이 왜 문제가 되는지, 심의에서 실제로 걸러본 표현 사례가 있나요?", pass: "심의 실사례 + 암 환우 감수성에 대한 조심스러움", red: "심의 경험이 사실상 없음 / 효능 단정 표현을 아무렇지 않게" },
    { text: "10년 경력에서 콘텐츠·SNS·홍보 축이 깁니다. 저희는 소재를 직접 만들고 매체를 직접 돌리는 실행자가 필요한데 — 본인 시간의 몇 %가 '직접 제작·직접 세팅'이었나요?", pass: "제작·세팅 비중을 솔직히 말하고 부족한 축의 보완 계획", red: "전 축을 다 잘한다는 식 / 기획·관리 비중이 높은데 인정 안 함" },
  ],
  "이재혁": [
    { text: "(첫 질문 — 통근) 용인 기흥에서 노원까지 편도 1시간 반이 넘습니다. 매일 가능하신가요? 이사 계획이 있으신가요?", pass: "현실을 인지하고 구체적 계획(이사·거리 수용 근거)", red: "'괜찮다'로만 뭉갬 — 조기 이탈 1순위 리스크" },
    { text: "(선고지) 희망 4,000~5,000으로 주셨는데, 저희 물류 포지션 레인지는 [대표 확정 숫자]입니다. 이 레인지면 진행 가능하실까요?", pass: "레인지 수용 또는 구조 협의 의향", red: "고정 고수 (※ 즉석 인상 발언 금지)" },
    { text: "SKU 7,000에 4,800셀, 지게차 6대 조직에 계셨죠 — 저희는 SKU 수십 개, 물류 담당 1명, WMS도 없습니다. 합류하면 본인의 하루가 어떨 것 같으세요?", pass: "입고·검수·출고·재고를 혼자 도는 현실적 하루 + 그걸 즐길 이유", red: "관리·체계 이야기부터 시작, 몸 쓰는 실무 회피" },
    { text: "메이크스타에서 만든 Loc 체계·SOP·입고 프로세스 — 우리 규모(약국 출고+B2B 납품+자사몰 택배)에 맞게 첫 30일 설계를 해본다면요?", pass: "엑셀+이카운트 수준의 현실적 단순화 설계", red: "대형 WMS 도입부터 꺼내는 과잉 설계" },
    { text: "물류센터 확장 이전(1,100→4,800셀)을 주도하셨는데 — 그 프로젝트에서 본인이 직접 한 것과 지시한 것을 나눠 주세요.", pass: "직접/지시 분리 + 실물 디테일(품목 리스트·선이동 등)", red: "총괄 요약만" },
    { text: "메이크스타를 올해 6월에 나오신 이유와, 그 전 파이엠스케이 시절 이야기를 짧게요.", pass: "사유 투명 + 일관", red: "얼버무림" },
  ],
  "이재희": [
    { text: "(선고지) 직전 연봉 4,500이셨는데, 저희 물류 포지션 레인지는 [대표 확정 숫자]입니다. 이 레인지면 진행 가능하실까요?", pass: "레인지 수용 또는 협의 의향", red: "고정 고수 (※ 즉석 인상 발언 금지)" },
    { text: "백화점·아울렛 30곳 B2B 납품에서 출고 정시율 99%를 유지하셨죠 — 그 프로세스를 걸어가 주세요. 저희 약국+B2B 납품에 이식한다면 첫 달에 뭘 만드시겠어요?", pass: "일정표·검수·배차의 실물 프로세스 + 우리 이식안", red: "숫자만 반복, 프로세스 설명 못 함" },
    { text: "화장품·명품과 달리 저희는 식품입니다 — 유통기한·선입선출이 생명인데, 뭐가 달라져야 합니까?", pass: "차이를 짚고 로트·선입선출 설계를 말함", red: "'비슷하다'로 뭉갬" },
    { text: "재고일치 99.91%는 DPS·오토라벨러가 있는 환경이었죠 — 설비가 없는 저희 환경에서 그 정확도를 무엇으로 재현하시겠어요?", pass: "주기·프로세스·엑셀/이카운트 수준의 현실 설계", red: "설비 없인 어렵다는 뉘앙스" },
    { text: "Qoo10 메가와리 때 일 20만 건 출고 — 주문량 예측→인력 산정은 어떻게 했나요? 저희도 광고가 터지면 주문이 몇 배로 뛰는데요.", pass: "예측 로직 + 피크 대응의 실물 경험(우리 '광고 터졌을 때' 시나리오 정합)", red: "회사 시스템이 다 했다는 식" },
    { text: "에스티엘을 작년 10월에 나오셨는데 그 사유와, 이후 기간은 어떻게 보내셨나요?", pass: "사유 투명 + 공백 설명 자연스러움", red: "얼버무림" },
  ],
  "황현수": [
    { text: "(선고지) 희망 연봉을 '회사내규'로 두셨는데, 저희 물류 포지션 레인지는 [대표 확정 숫자]입니다. 희망 숫자를 먼저 여쭤봐도 될까요?", pass: "숫자 명확+레인지 정렬", red: "회피 / 직전 생산직 6,000 기준 기대 (※ 즉석 인상 금지)" },
    { text: "하트피스에서의 하루를 걸어가 주세요 — 이카운트로 B2B 주문 접수부터 출고, 월 2회 재고 실사까지 어떤 순서로 하셨나요?", pass: "이카운트 메뉴·전표 수준의 디테일(우리 ERP 그대로 — 온보딩 0)", red: "개괄 설명만, 시스템은 다른 사람이 만짐" },
    { text: "SKU 350종에서 재고가 안 맞을 때 — 오입출을 어떻게 찾아 수정하셨나요? 실제 사례 하나요.", pass: "추적·수정 프로세스 실물", red: "'실사하면 맞춰진다' 수준" },
    { text: "3PL 업체와 입출고 일정 조율, 거래처 납기 배차 — 충돌 났던 사례와 해결은요?", pass: "조율 실사례+거래처 커뮤니케이션", red: "사례 없음" },
    { text: "핫시즈너 4년 6개월 생산을 하시다가 물류로 전환하신 이유와, 이 전환이 앞으로도 유지될 거라고 봐야 하는 이유는요?", pass: "전환 사유 일관+물류 정착 의지(물류관리사 공부 등)", red: "떠밀린 전환" },
    { text: "저희는 물류 담당 1명입니다 — 입고 검수부터 택배 포장, 약국 납품 배차, 재고 실사까지 혼자입니다. 본인의 하루가 어떨 것 같으세요?", pass: "현장+사무를 오가는 현실적 그림", red: "사무 위주 기대" },
  ],
  "한선진": [
    { text: "(최초반 확인) 직전 브이플랫폼이 2개월입니다 — '구매/SCM 역량 성장을 위해'라고 쓰셨는데, 실제로 무슨 일이 있었나요?", pass: "구체적·솔직한 사유(입사 전 약속과 다른 역할 등)+일관성", red: "얼버무림 — 이 답이 모호하면 이후 판정 전체 보수적으로" },
    { text: "(선고지) 희망 4,000~5,000으로 주셨는데 저희 레인지는 [대표 확정 숫자]입니다. 이 레인지면 진행 가능하실까요?", pass: "정렬 또는 솔직한 협의", red: "고수 (※ 즉석 인상 금지)" },
    { text: "리마코리아에서 수기 재고를 이카운트로 전환하셨다고요 — 무엇을 어떤 순서로 세팅했는지 걸어가 주세요. 품목 코드 체계부터요.", pass: "구축 순서·기준 수립·교육까지 실물(우리 이카운트 고도화에 즉시 이식)", red: "업체가 세팅해준 걸 운영만" },
    { text: "의료기기 LOT·유효기간 관리를 하셨는데 — 저희는 식품입니다. 유통기한·선입선출 관리로 옮기면 뭐가 같고 뭐가 다릅니까?", pass: "동일 문법 인지+식품 차이(회전 속도·폐기) 짚음", red: "'비슷하다'로 뭉갬" },
    { text: "위탁(3PL) 재고 운영에서 우리 장부와 3PL 장부가 안 맞을 때 어떻게 잡으셨나요?", pass: "대사 프로세스 실물", red: "사례 없음" },
    { text: "저희는 약국 B2B 납품이 큽니다 — 리마코리아의 거래처 공급 일정 조율·공급내역보고 경험을 우리 구조에 이식한다면 첫 달에 뭘 만드시겠어요?", pass: "납품 캘린더·수불 체계 등 구체안", red: "일반론" },
  ],
  "강한별": [
    { text: "(최초반 확인) 최근 세 회사가 7개월·11개월·8개월입니다 — 회사별로 나오신 이유를 하나씩 짧게 듣고 싶습니다.", pass: "사유 개별 납득+패턴 자각('안정된 자리를 찾는 중')", red: "전부 회사 탓 / 자각 없음" },
    { text: "(선고지) 희망 3,600~3,800으로 주셨습니다 — 저희 레인지와 맞습니다. 연봉 외에 이 자리에서 기대하시는 게 뭔가요?", pass: "정착·전문성(물류관리사·건국대 공급망)의 그림", red: "조건 재협상 시도" },
    { text: "옵티머스솔루션스에서 건강기능식품 SCM을 하셨죠 — 3PL 핸들링과 B2B 발주에서 본인이 직접 한 것을 실사례로 걸어가 주세요.", pass: "건기식 물류 디테일(우리 카테고리 직경험)", red: "개괄 요약" },
  ...
  "김소영": [
    ...
    { text: "(경력 구성) 지원서 요약에는 뉴트리엄(캐나다 건기식) 3년 8개월로 나오는데, 포트폴리오에는 길재소프트웨어·차트·매드스퀘어·브릿지코드 국내 4개사가 있네요 — 연도별로 커리어 타임라인을 걸어가 주세요.", pass: "타임라인이 매끄럽게 정리되고 각 회사 재직 기간·역할이 명확", red: "설명이 꼬임 / 기간을 얼버무림 (정직성 관문)" },
    { text: "브릿지코드-택슬리는 세무상담 플랫폼이죠 — 저희도 상담약국(35만원 유료 상담)이 핵심 모델입니다. 상담 전환 퍼널에서 본인이 직접 만진 것과 성과를 걸어가 주세요.", pass: "퍼널 단계·지표·본인 기여가 구체적 (우리 모델 이식 가능성)", red: "GA 세팅 얘기만 / 전환 성과 설명 못 함" },
    { text: "월 광고비를 얼마까지 직접 운영해보셨나요? 포트폴리오의 A/B 4배·릴스 6.3만 같은 성과의 모수(예산·기간)도 함께요.", pass: "규모를 정직하게 말하고 소형이면 스케일업 학습 계획 제시", red: "모수를 숨기고 배율만 반복" },
    { text: "Higgsfield로 AI 콘텐츠를 만드신다고요 — 저희도 씁니다. 실제 워크플로우(프롬프트→편집→업로드)를 걸어가 주시고, 건기식·환자 대상 콘텐츠에 쓸 때 뭘 조심해야 할까요?", pass: "실사용 디테일 + 감수성·심의 인지", red: "툴 이름 나열 / 효능 표현 무감각" },
    { text: "저희 공고를 여러 번 스크랩하셨더라고요 — 큐라엘의 뭘 보셨나요? 유튜브나 자사몰 보셨으면 솔직히 아쉬운 점 하나만요.", pass: "실제로 본 흔적 + 비판 섞인 솔직함(동기의 실체)", red: "칭찬만 / 사실 잘 모름이 드러남" },
    { text: "3년 뒤 어떤 모습이면 '이 이직이 맞았다'고 하시겠어요?", pass: "우리 구조에서 실현 가능한 그림", red: "모호 / 빠른 관리자 복귀형" },
  ],
};
...
const CAREER_BUILTIN = {
  ...
  "정유철": {
    birth: 1985, edu: "영산대(부산) 영어학 졸업(4.3/4.5) · 부경대 시각디자인 편입 후 중퇴 · 웹디자인기능사·국제타이포전 수상",
    header: "총 11년 1개월 (8개사) — 디자인+퍼포먼스 겸장, ⚠ 최근 3개사 8·8개월·1년10개월 + 팀장 연속",
    rows: [
      { current: true, company: "현재 구직 중", role: "동일제약 퇴사 후", since: "2026.02" },
      { company: "㈜동일제약", role: "커머스사업부 마케팅 팀장", period: "2024.05~2026.02", dur: "1년 10개월", work: "스킨케어 브랜드 운영 — META/GFA/SA/DA 직접 운영, 시장 분석 기반 신제품 기획·디자인, IMC 실무 (연봉 7,000)" },
      { company: "㈜유니박", role: "마케팅팀장", period: "2023.10~2024.05", dur: "8개월 ⚠", work: "온라인 채널·웹사이트 구축, 시즌 제품 기획·디자인, 페이드 퍼포먼스·데이터 분석" },
      { company: "㈜웨이크", role: "신규사업팀장 (브랜드디자인)", period: "2023.02~2023.09", dur: "8개월 ⚠", work: "신규 브랜드 BX 리딩, 웹·패키지·콘텐츠 디자인 실무" },
      { company: "㈜커버프렌즈", role: "그로스팀장", period: "2020.05~2023.01", dur: "2년 9개월 ★", work: "제품·마케팅·디자인 총괄+실무, KPI 관리 — 포트폴리오: 오프라인 적자→월매출 1억 커머스, Max ROAS 480%, 연매출 20억+" },
      { company: "365위더스", role: "디자인팀장", period: "2019.02~2020.05", dur: "1년 4개월", work: "브랜드 기획·신규 런칭·콘텐츠 IMC" },
      { company: "로커스", role: "디자인팀장", period: "2018.02~2019.02", dur: "1년 1개월", work: "브랜딩·영상 UI·웹 UX" },
      { company: "아웃피터스", role: "마케팅 디자인 매니저", period: "2015.10~2017.09", dur: "2년", work: "콘텐츠 제작 실무·이커머스 운영·브랜드 디렉팅" },
      { company: "뉴웨이브크리에이티브", role: "디자인 사원", period: "2015.02~2015.10", dur: "9개월", work: "브랜딩 실무" },
    ],
    note: "포트폴리오(jeongyucheol.github.io/performance): COSWORKER 매출 0→연 5억·ROAS 420%, FORBIDDEN EDEN ROAS 580%, GREEDILOUS ROAS 700% — 본인 기여 분리가 검증 핵심",
  },
  "이시라": {
    birth: 1996, edu: "홍익대학교(서울) 경제학부 졸업(3.29/4.5) · GA·GTM·Photoshop·Cafe24·Figma",
    header: "총 5년 7개월 (3개사) — ✅ 직전 4년 5개월 안정 근속, 건강식품 직경험",
    rows: [
      { current: true, company: "현재 구직 중", role: "블렌디드 퇴사 후", since: "2026.07" },
      { company: "블렌디드", role: "브랜드매니저·브랜드마케터 (마케팅유닛·상품유닛)", period: "2022.03~2026.07", dur: "4년 5개월 ★", work: "에어베리·포쉬·코어뉴트리션(건강식품) 담당 — Meta·네이버·카카오·쿠팡 직접 운영(월 최대 2.7억, ROAS 400%), Cafe24 자사몰·스마트스토어·쿠팡 로켓, 카카오채널 2만→5만 CRM, 액상 비오틴 신제품 E2E 런칭, NS홈쇼핑 런칭 총괄, 글로벌몰(홍콩·싱가포르) 기반 구축" },
      { company: "슬라운드", role: "퍼포먼스 마케터", period: "2021.04~2022.01", dur: "10개월", work: "Meta·네이버·카카오 운영, 겨울 시즌 재고 80% 소진, 온보딩 프로세스 구축" },
      { company: "퀸즈코퍼레이션", role: "온라인 마케터", period: "2020.12~2021.03", dur: "4개월", work: "퍼널 분석·KPI 수립·GA 세팅" },
    ],
    note: "🗓 면접 9/1(월) 10:00 · 희망 5,500(예산 정합) · 2주 내 입사 가능 · 강동구 길동. ⚠ 그룹바이 1군이었던 방주환과 같은 회사(블렌디드) 출신 — 조직·본인 평판 교차 검증 기회",
  },
  "김남수": {
    birth: 1987, edu: "경민대 e-Business경영(3.74) · GA 실무·SQL·PM/PO 과정 수료 · 마케팅지도사 3급",
    header: "총 16년 (9개사) — 건기식·식품 D2C 총괄 3년 5개월 + 창업 4년 6개월 + 고관여 그로스 3년 7개월",
    rows: [
      { company: "교보라이프플래닛생명", role: "서비스그로스팀 차장", period: "2022.11~2026.05", dur: "3년 7개월 ★", work: "보험 D2C — 콘텐츠·진단→상담→계약 퍼널 설계(우리 상담 모델과 동일 문법), 인증 전환 44→84%, 상담→청약 12.1%, 재접속 6.4→46.3%, CAC 1/4·LTV 2배. 희망퇴직으로 퇴사(회사 구조개편)" },
      { company: "교동식품", role: "온라인사업 총괄 팀장 (15명)", period: "2021.06~2022.12", dur: "1년 7개월", work: "식품 D2C 자사몰 0→1 — 오픈 3개월 내 월매출 400만→3억+(자사몰 단독), ROAS 300%+, Meta·IG·YouTube·카카오·GFA 인하우스 직접 운영, 월 신규회원 1.5만" },
      { company: "센트럴팜", role: "온라인사업총괄 부장 (15명)", period: "2020.01~2021.05", dur: "1년 5개월", work: "건기식·이너뷰티 — 신제품 11종(4개 브랜드) 런칭, 심의 메시지 매트릭스(팔리는 표현 vs 심의 통과 표현 분리), Mykind 런칭 6개월 평균매출 3배" },
      { company: "파워풀엑스", role: "팀장", period: "2019.09~2020.01", dur: "5개월 ⚠", work: "건기식 IMC·퍼포먼스 직접 운영 — 사내 전략 공모전 최우수상" },
      { company: "아이인컴퍼니 (창업)", role: "대표 (최대 20명)", period: "2015.01~2019.06", dur: "4년 6개월", work: "광고·매체 기업 창업·경영 — P&L·3개 사업부. 시장 급변으로 법인 정리 후 인하우스 트랙 전환" },
      { company: "미소다컴·티원에듀케이션·M전략시스템", role: "초기 5년 (대행·1인 인하우스·컨설팅)", period: "2010.05~2015.01", dur: "4년 10개월", work: "광고주 40개+ 운영, 마케팅 1인 총괄 경험" },
    ],
    note: "❌ 면접 취소(09.01 대표 확정) — 진행하지 않음. (이하 기록 보존) 현재 8,500/희망 9,500. AI: Claude Code·Codex 자동화 파이프라인 직접 운영. 지원서에서 큐라엘 모델('제품·정보·상담 연결')을 정확히 명시한 유일한 후보",
  },
  "황유정": {
    birth: 1992, edu: "숭실대학교 정치외교학 학사(3.25/4.5) · MOS Master",
    header: "총 10년 2개월 (6개사) — 콘텐츠·SNS 축이 김, 건강식품 현직 · 퇴사 사유 대부분 회사 사정(폐업·팀해체·계약만료)",
    rows: [
      { company: "㈜에이치데일리", role: "마케팅팀 과장 (재직중)", period: "2025.02~", dur: "1년 7개월", work: "혈당·체중 건강식품 — 생성형 AI 숏폼 광고 제작 프로세스 구축, Meta 소재 기획·세팅·효율 분석, 리모네 레몬애사비·톡스핏·하이아 알파CD 등 신제품 론칭, 상세페이지·체험단·인플루언서. 이직 사유: 경영환경 변화" },
      { company: "화요·광주요", role: "홍보실 대리", period: "2022.12~2024.07", dur: "1년 8개월", work: "연간 SNS 전략·콘텐츠, Meta·네이버·카카오 직접 운영, 광주요 자사몰 ROAS 1,000%+, 팝업·보도자료. 퇴사: 구조조정 팀 해체" },
      { company: "빗썸라이브", role: "마케팅팀 대리", period: "2022.02~2022.12", dur: "11개월", work: "신규 라이브커머스 앱 BI·상세페이지·광고. 퇴사: 회사 폐업" },
      { company: "엣지랭크", role: "Creative2 대리", period: "2021.09~2022.01", dur: "5개월", work: "이디야커피 공식 SNS 운영(대행). 퇴사: 빗썸 스카우트" },
      { company: "MBC", role: "디지털뉴스편집팀 파견직", period: "2019.03~2021.03", dur: "2년", work: "엠빅뉴스·14F 디지털 콘텐츠 배포·바이럴. 퇴사: 계약 만료" },
      { company: "곰앤컴퍼니", role: "콘텐츠사업팀 대리", period: "2015.04~2018.11", dur: "3년 8개월", work: "곰플레이어 VOD 운영·CRM·데이터 기반 기획, 네이밍 공모전 1위 2회" },
    ],
    note: "🗓 면접 9/2(화) 14:00 · 현 4,999(고정급)/희망 협의 — 예산 정합 ✅ · 구로구 신도림 · JnCHR 조천수 20%. ⚠ 매체 볼륨(월 광고비 규모) 미기재 — 면접에서 확인",
  },
  "이재혁": {
    birth: 1995, edu: "세종사이버대학교 유통물류학과 졸업(3.5/4.5) · 지게차 운영 관리 · WMS",
    header: "총 8년 6개월 — 재고관리 파트장(물류 프로세스 0→1 구축형) · ⚠ 용인 기흥 거주(노원 통근 확인 필수)",
    rows: [
      { company: "메이크스타", role: "운영1팀 재고관리파트 대리/파트장", period: "2024.05~2026.06", dur: "2년 2개월", work: "SKU 7,000 전수 Loc 체계 구축(피킹존·보충존 설계), 자체 WMS 기능 개발 기획(10,900 SKU 상품명·상세 조사→반영), SOP 작성(음반·굿즈 표준 절차), 물류센터 확장 이전 주도(1,100→4,800셀·재고 1,600plt 이동), 입고 프로세스 고도화(발주 대사·검수·적치 세분화), 지게차 6대·핸드리프트 운영 관리, 신사업 TF" },
      { company: "파이엠스케이", role: "재고관리·물류관리", period: "이전 경력", dur: "약 6년", work: "재고관리·물류관리 실무" },
    ],
    note: "🗓 물류 면접 확정(일시 미정) · 현 4,050/희망 4,000~5,000 (⚠ 물류 예산 레인지 대표 확정 필요 — 시장 실무가 2,700~3,300, 관리자급 3,500~) · 사람인 공고① 1차면접 승격",
  },
  "이재희": {
    birth: 1995, edu: "학점은행제 재학중 · WMS·DPS(디지털 피킹)·오토라벨러 등 자동화 설비 운용",
    header: "총 6년 11개월 — 화장품·명품 물류 파트장(정밀 운영형: 재고일치 99.91%·오배송 0.07%) · 용산구 거주",
    rows: [
      { company: "㈜에스티엘", role: "물류 전담 파트장", period: "2023.11~2025.10", dur: "2년", work: "화장품 물류 전반 — SKU·유통기한·LOT 관리, 재고+3PL 서비스 관리, DPS·오토라벨러 자동화 설비 운용, 재고일치 99.91%·오배송률 0.07%·당일 출고율 100%, 일본 Qoo10 메가와리 대형 프로모션 일별 주문량 예측→인력 산정→최대 20만 건 출고·라스트마일 운영" },
      { company: "케이엘엔로지스틱스", role: "물류 파트장", period: "2020.09~2023.07", dur: "2년 11개월", work: "몽클레르·스톤아일랜드 명품 물류 — 이탈리아 본사 전담팀·영문 메일/LINE 직접 소통·WMS 오류 시스템 문제 해결, 전국 30여 백화점·아울렛 B2B 납품 출고 일정·공정 관리(출고 정시율 99%), 김포 800평→인천 4,000평 물류센터 확장 이관 프로젝트 참여" },
      { company: "디앤에이치피플", role: "매장운영·재고관리", period: "2018.07~2019.10", dur: "1년 4개월", work: "이랜드리테일 매장 운영·재고관리" },
    ],
    note: "🗓 물류 면접 확정(일시 미정) · 직전 4,500/희망 내규 · 사람인 공고②(노원구) 서류에서 대표가 면접 승격. B2B 백화점 납품+화장품 유통기한 관리 경험 = 우리 약국+B2B 문법과 정합",
  },
  "황현수": {
    birth: 1991, edu: "한국경마축산고 졸업 · 축산기능사·워드2급 · 응급처치·승강기안전 교육 이수",
    header: "총 14년 8개월 — 최근 2.5년이 식품 물류(이카운트·B2B·3PL), 그 전은 생산·주방 트랙 · 성북구 장위동",
    rows: [
      { company: "㈜하트피스", role: "물류팀 대리 · 물류관리", period: "2024.11~2026.07", dur: "1년 9개월", work: "식품 생산공장 3개 브랜드 물류·재고 — 이카운트 ERP로 B2B 주문 접수·출고 관리, 원부자재+완제품 SKU 350종, 3PL 입출고 일정 조율, 거래처 납기 맞춤 배차 계획, 월 2회 재고 실사(오입출 수정), WMS·Excel 데이터 관리" },
      { company: "베이컨리얼리즘", role: "물류팀 사원", period: "2024.06~2024.11", dur: "6개월", work: "베이컨 가공·포장+B2C 주문 수집·재고·출고. 퇴사: 계약만료" },
      { company: "핫시즈너(동대문엽기떡볶이 본사)", role: "가공팀 · 생산", period: "2020.01~2024.06", dur: "4년 6개월", work: "HACCP 기반 떡 생산·위생관리 (기재 연봉 6,000 — 면접 확인 필요). 퇴사: 개인사정" },
      { company: "그릴타이·한화갤러리아승마단 외", role: "주방 매니저·마필관리", period: "2010~2019", dur: "약 8년", work: "주방 발주·재고·품질 4년 + 승마단 마필관리(특성화고 전공)" },
    ],
    note: "🗓 물류 면접 9/7 11:00 · 희망 '회사내규'(선고지로 숫자 먼저) · ✅이카운트+식품 B2B+3PL = 우리 문법 그대로 · ⚠물류 순수 경력은 하트피스 중심 ~2.5년",
  },
  "한선진": {
    birth: 1992, edu: "동서울대 실내디자인 졸업(4/4.5) · 1종보통 · 물류 직무 포트폴리오 PDF 별첨(사람인)",
    header: "총 8년 11개월 — 이카운트 ERP를 두 회사에서 '직접 구축'한 재고·SCM 형 · 중랑구 · ⚠직전 회사 2개월 초단기",
    rows: [
      { company: "브이플랫폼", role: "경영지원 대리/파트장 · SCM", period: "2026.05~2026.06", dur: "2개월 ⚠", work: "이카운트 기반 재고/구매 프로세스 정비, 생산 BOM 전표 체계, 출고 요청 표준화, 3PL 재고 연계, 구매단가 마스터. 퇴사 사유 기재: '구매/SCM 역량 성장' — 최초반 확인 필수" },
      { company: "리마코리아", role: "물류팀 과장 · 재고관리", period: "2021.08~2026.05", dur: "4년 10개월 ★", work: "해외 의료기기 수입 물류 — 통관→입출고, LOT·UDI·유효기간 관리, 위탁(3PL)재고 운영, 거래처 재고·공급 일정 조율, 공급내역보고·월 마감, 재고 실사·감사 대응. 수기 재고를 이카운트 ERP로 전환(전산 구축+운영 기준 수립+사용자 교육 직접)" },
      { company: "한국카앤라이프·아이티온·SUled", role: "초기 4년", period: "2016~2021", dur: "약 4년", work: "사고차량 부품 견적·납품 / 서비스센터 AS·재고·마감 / 상품 제작·포장" },
    ],
  ...
  "강한별": {
    ...
    rows: [
      { company: "유엠아키", role: "영업팀 주임 · 구매관리", period: "2025.10~2026.04", dur: "7개월 ⚠", work: "자체창고 물류 수발주·부자재 관리, 현장 납품·자재 핸들링, 비교견적·거래처 확보" },
      { company: "㈜옵티머스솔루션스", role: "SCM", period: "2024.08~2025.06", dur: "11개월", work: "**건강기능식품 SCM** — 물류관리·자재창고관리+3PL 핸들링, B2B 발주·현장 이슈 컨트롤 (연 3,500). 퇴사: 근무조건" },
      { company: "㈜리샘", role: "자재창고 관리", period: "2023.10~2024.05", dur: "8개월 ⚠", work: "자재창고 관리 + **쿠팡 밀크런 납품 세팅**" },
      { company: "이고진", role: "메인/파트장", period: "2021.03~2023.01", dur: "1년 11개월", work: "물류 재고관리·출하·지게차 (연 3,700)" },
      { company: "네오퍼스·서환산업", role: "초기", period: "2016~2019", dur: "약 3년 9개월", work: "재단·조립·포장·지게차 / 기계설비 수리·사무보조(MSDS·유류 서류)" },
    ],
    note: "🗓 물류 면접 9/8 5시(오후 추정·확인) · 희망 3,600~3,800(예산 정합 가능성 최고) · ✅건기식 SCM 직경험+쿠팡 밀크런+지게차·OA 겸장(1인 물류 적합) · ⚠관문: 최근 3연속 단기 근속 사유",
  },
  "김소영": {
    birth: 1994, edu: "포트폴리오(노션 Maketer) 기준 — GA4·GTM·Google Ads·Data Studio·Meta·Figma·프리미어·포토샵·Higgsfield AI",
    header: "잡코리아 요약 3.8년 — ⚠ 포트폴리오에는 국내 4개사 경력(길재소프트웨어·차트·매드스퀘어·브릿지코드) — 경력 구성이 지원서 요약(뉴트리엄 캐나다)과 달라 면접 최초반 확인 필수",
    rows: [
      { company: "길재소프트웨어 (Work 4·최근)", role: "마케팅", period: "기간 미상", dur: "-", work: "광고·콘텐츠 기획·GA4·메타 퍼포먼스" },
      { company: "차트 Chaart (아트컬렉팅 플랫폼)", role: "마케팅", period: "기간 미상", dur: "-", work: "메타·구글애즈·뉴스레터·카카오톡 채널·GTM" },
      { company: "매드스퀘어", role: "마케팅", period: "기간 미상", dur: "-", work: "동남아시아 B2B·인플루언서·콘텐츠 마케팅" },
      { company: "브릿지코드-택슬리 (세무상담 플랫폼)", role: "퍼포먼스 마케팅", period: "기간 미상", dur: "-", work: "GA·GTM·SA·DA — 상담 플랫폼 퍼널 경험(우리 상담약국 모델 접점)" },
    ],
    note: "❌ 면접 취소(09.01 대표 확정) — 진행하지 않음. (이하 기록 보존) 연봉 '면접 후 결정' — 최초반 선고지 필수. ✅ 공고 반복 스크랩=동기, AI 콘텐츠 제작·Higgsfield 사용(우리 스택과 일치). ⚠ 포트폴리오 성과 규모가 소형(릴스 6.3만 조회·구독 800명·A/B 4배) — 월 1,000만 광고비 국면과의 갭 검증",
  },
  "왕태일": {
    birth: 1983, edu: "서울디지털대 디지털디자인(전공)+마케팅(복수) 4.03 · 연세대 브랜드 전문가 수료 · 이라크 파병(육군)",
    header: "총 18년 (6개사) — 본부장·창업·사업총괄 트랙, 최근 3개사 7개월·2년7개월·4개월(재직중)",
    rows: [
      { company: "㈜비욘드허니컴", role: "마케팅 스페셜리스트 (재직중)", period: "2026.05~", dur: "4개월", work: "AI 그릴 GRILL X — Google·Meta·GA4·CRM 연결 B2B 디맨드젠, 월 400건+ 리드, 랜딩 전환 개선" },
      { company: "㈜이너스커뮤니티", role: "브랜드사업 본부장", period: "2023.11~2026.05", dur: "2년 7개월 ★", work: "도드람 캔돈 제품개발 PM·iF디자인 수상, 인스탁스 WIDE EVO 론칭 목표 140%, 코렐 매출 2배, AEO/GEO 솔루션 Team HAI 론칭(ICT AWARD GRAND PRIX)" },
      { company: "더워터멜론㈜", role: "디지털사업팀 리드 (수석부장)", period: "2023.03~2023.09", dur: "7개월 ⚠", work: "BE-KIND 한국 론칭(코스트코·스타벅스 입점 기반), 교보문고 문보장 1호점, 대상웰라이프 아르포텐(건기식) 컨설팅" },
      { company: "왕조시대 컴퍼니㈜ (창업)", role: "Founder / 사업총괄", period: "2022.01~2023.03", dur: "1년 3개월", work: "JM솔루션 약쑥 앰플 론칭 120%·올리브영 판매, 키즈 브랜드 MVP, 유아동 커머스 연매출 2억" },
      { company: "㈜도브투래빗", role: "마케팅사업 본부장", period: "2012.04~2021.12", dur: "9년 9개월 ★", work: "마케팅 조직 35명·약 200억 비즈니스 운영, CJ올리브영 온드미디어 자산화(어워즈&페스타), 뷰티 디바이스 FROMST D2C(스마트스토어 ROAS 300%+), SSG PAY 론칭" },
      { company: "㈜유웨이어플라이", role: "전략사업부 AE", period: "2009.10~2011.11", dur: "2년 2개월", work: "대학 광고·수험생 DB 미디어 상품(연매출 10억+), 입시 앱 기획 PM" },
    ],
    note: "⚠ 직전·희망 연봉 8,700 — 상한 5,500과 3,200 차이. 실행자 채용이 아니라 '총괄 트랙 가치 vs 비용' 판단 면접임을 서로 명확히",
  },
};
...
const FOCUS_BUILTIN = {
  ...
  "박현철": {
    verdict: "🗓 2차 면접 9/2(화) 7시(오후 추정 — 확인 필요). 판정 기준: 재지원 사유 납득 + 조건 재선고지 수용 + '직접 수행 비중' — 커피챗 종결 권고를 뒤집을 실물이 나와야 추천",
    points: [
      ["🔑 연봉 7,000 → 5,500 수용 (최초반 확인)", "실질 관문 1 — '일단 들어가서 조정' 뉘앙스면 종료 (김동현: 7천은 작은 연봉 아님)"],
      ["🔑 팀원 구성·본인 직접 수행 비중 (08.21 추가)", "경력기술서 범위가 넓음 — 이전 회사 팀 인원·업무 비중을 묻고 직접/위임을 분리시켜라 (김동현·상무 합의 체크포인트)"],
      ["조직 세팅 의지 + 큐라엘에서의 목표 (08.21 추가)", "실무 0명부터 시작 → 조직 세팅 → 팀장의 여정을 갈 의사·중심이 있는가. 3년 뒤 목표 질문 — 팀장 이탈은 조직 전체가 흔들린다"],
      ["건기식 갭 + 심의 게이트", "건기식 경험 적음(커머스 이해는 높음) — 식품 성공사례·걸러낸 표현 실사례가 나오면 가점, '다 똑같다'면 감점"],
  ...
  "정유철": {
    verdict: "판정 기준: ①연봉 수용(희망 6~7천 → 상한 5,500) + ②포트폴리오 성과의 '본인 손' 증명 — 둘 다 통과 시 추천",
    points: [
      ["🔑 연봉 선고지 최초반", "직전 7,000·희망 6~7천 vs 상한 5,500 — 박현철 교훈: 즉석 앵커 상향 발언 금지, 수용 불가 뉘앙스면 정중히 조기 종료"],
      ["🔑 기여 분리", "COSWORKER 0→연 5억·ROAS 420% 등 수치가 화려함 — 기획/디자인/매체 중 '직접 손'과 '팀장 지시'를 분리시켜라. 최근 3개월 내 직접 세팅 사례 요구"],
      ["강점 검증: 디자인+퍼포먼스 겸장", "시각디자인 출신 + META/GFA/SA/DA 운영 — 진짜면 소재제작(×3.0) 축 최적. 단 스킨케어=화장품 표시광고, 건기식 심의 차이 인지 확인"],
      ["⚠ 단기 반복 + 공백", "유니박 8개월·웨이크 8개월 사유 개별 확인, 2026.02 퇴사 후 6개월 공백 — 팀장 8년인데 팀원 0명 실무 자리 수용 여부"],
    ],
  },
  "왕태일": {
    verdict: "판정 기준: 실행자 채용 면접이 아님 — '총괄 트랙 가치 vs 비용(8,700)' 판단. 조건 정렬 안 되면 탤런트풀 보관 (자문 카드로도 검토)",
    points: [
      ["🔑 조건 갭 정면 확인", "직전·희망 8,700 vs 상한 5,500 (3,200 갭) — 어떤 협업 구조면 서로 의미 있는지 탐색. 즉석 연봉 약속·앵커 상향 발언 절대 금지"],
      ["🔑 손 vs 지휘", "최근 10년이 본부장·총괄 — 최근 6개월 내 본인 손으로 세팅한 캠페인·직접 만든 소재 실물을 요구 (마케터 0명 환경 적합성)"],
      ["활용 각도 탐색", "도드람 캔돈 제품개발 PM·BE-KIND 론칭·대상웰라이프(건기식) 컨설팅 + AEO/GEO 솔루션 — 100억 지표 트리·B2B/MSO 어젠다와 접점, 풀타임 아니어도 자문 가치"],
      ["현직 4개월 이직 사유", "비욘드허니컴 재직 4개월째 + 2023년 7개월·창업 1년3개월 리듬 — 자각과 사유 확인"],
    ],
  },
  "이시라": {
    verdict: "판정 기준: 매체 '직접 손' + 블렌디드 퇴사 사유 납득되면 채용 추천 — 조건(5,500)은 이미 정합, 깎지도 올리지도 말 것",
    points: [
      ["🔑 손 vs 팀 분리", "월 2.7억 운영이 본인 세팅인지 팀 분업인지 — 캠페인 구조를 직접 걸어가게 하라. 최근 직접 세팅 시점 확인"],
      ["🔑 블렌디드 4년 5개월 퇴사 사유", "잘 다니던 회사를 7월에 나온 이유 — 납득 안 되면 보류. 같은 회사 출신 방주환(그룹바이 1군) 이야기로 조직 교차 검증 가능"],
      ["감수성·심의", "코어뉴트리션은 건기식 — 우리는 일반식품+암 환우 감수성. 베지셀 첫 소재 3안 즉석 질문으로 확인"],
      ["✅ 유지할 것", "조건 갭 없음(희망 5,500) — 면접에서 연봉 얘기는 '레인지 일치 확인' 한 문장이면 끝. 즉석 인상 발언 금지"],
    ],
  },
  "김남수": {
    verdict: "판정 기준: ①연봉(희망 9,500 vs 총괄 예산 [대표 확정 필요]) 구조 합의 가능성 + ②0→1 성과의 '본인 손' 증명 — 둘 다 통과 시 총괄 트랙 최우선 추천",
    points: [
      ["🔑 연봉 선고지 최초반", "현 8,500/희망 9,500 — 왕태일(8,700) 교훈: 즉석 수락·앵커 상향 금지. '총괄 예산 레인지 + 성과 연동 구조'로만 말하고 구체 숫자는 서면 오퍼로"],
      ["🔑 0→1의 손 검증", "교동식품 3개월 월 3억 — 첫 30일을 일 단위로 걸어가게 하라(직접 vs 지시 분리). 15명 '관리'가 아니라 뭘 '만들었는지'"],
      ["심의 매트릭스 실물", "'팔리는 표현 vs 심의 통과 표현' 매트릭스를 화이트보드에 그려달라 하고, '암 환우' 표현에 즉석 적용 — 우리 최대 리스크 영역의 실전 검증"],
      ["상담 퍼널 이식", "교보 진단→상담→계약 퍼널을 우리 상담약국 모델에 이식하면 첫 분기에 뭘 만들 것인가 — 지원서 주장의 실행 전환 확인"],
      ["⚠ 확인", "파워풀엑스 5개월 사유 · 교보 희망퇴직 경위 · 창업 폐업의 교훈('본업 잘될 때가 가장 위험')을 우리 40억→100억 국면에 적용하면?"],
    ],
  },
  "황유정": {
    verdict: "판정 기준: ①현직 이직 사유 납득 + ②'직접 제작·직접 세팅' 비중 증명 — 둘 다 통과 시 실행 트랙 추천 (조건은 4,999 정합, 깎지도 올리지도 말 것)",
    points: [
      ["🔑 손 vs 기획", "10년 중 콘텐츠·SNS·홍보 축이 김 — AI 숏폼 프로세스를 화이트보드에 걸어가게 하고, Meta 월 광고비 규모·포맷별 CTR을 숫자로 요구. 대행 관리형이면 부적합"],
      ["🔑 현직 이직 사유", "에이치데일리 1.7y 재직 중 + '경영환경 변화' — 직전 3개사가 폐업·팀해체·계약만료라 회사 복은 없는 편. 이번 사유가 구체적인지"],
      ["ROAS 1,000% 구성", "광주요 자사몰 — 브랜드 지명검색·재구매 비중을 스스로 분리하는가(숫자 정직성)"],
      ["✅ 유지할 것", "현 4,999/희망 협의 = 예산 정합 — 연봉은 레인지 확인 한 문장이면 끝. 건강식품 현직 + 신제품 론칭 3건은 강점"],
    ],
  },
  "이재혁": {
    verdict: "판정 기준: ①통근(용인→노원) 지속 가능성 + ②대형 센터 파트장→1인 인하우스 물류 수용 — 둘 다 통과 시 '프로세스 빌더' 카드로 추천",
    points: [
      ["🔑 통근 (첫 질문)", "용인 기흥 거주 — 근무지는 노원(약국+B2B 물류). 편도 1.5시간+ — 지속 가능한지, 이사 계획이 있는지 정면으로"],
      ["🔑 규모 다운시프트", "SKU 7,000·4,800셀·지게차 6대 조직에서 → 우리는 SKU 수십 개·1인 물류·WMS 없음. '혼자 다 하는 하루'를 그려보게 하라 — 체계 구축 욕구가 소규모 현실과 맞는가"],
      ["0→1 이식", "Loc 체계·SOP·입고 프로세스를 우리 규모에 맞게 단순화한 첫 30일 설계 — 과잉 설계(대형 WMS 도입부터)면 ⚠, 엑셀+이카운트 수준의 현실 설계면 ✅"],
      ["연봉 선고지", "현 4,050/희망 4,000~5,000 — 물류 예산 레인지[대표 확정] 선고지 후 진행"],
    ],
  },
  "이재희": {
    verdict: "판정 기준: ①연봉(직전 4,500) 정렬 + ②화장품→식품(유통기한·선입선출) 전환 감각 — 통과 시 '정밀 운영' 카드로 추천. B2B 납품 경험은 우리 문법과 최고 정합",
    points: [
      ["🔑 B2B 납품 이식", "백화점 30곳 납품 정시율 99% 프로세스를 우리 약국+B2B 납품에 어떻게 이식할지 — 출고 일정표·검수·차량 배차의 실물 워크스루"],
      ["🔑 식품 전환", "화장품·명품은 유통기한 압박이 낮음 — 식품의 선입선출·유통기한 관리를 어떻게 설계할지. '같다'고 하면 ⚠, 차이를 짚으면 ✅"],
      ["자동화 없는 환경", "DPS·오토라벨러 쓰던 사람 — 설비 0인 우리 환경에서 재고일치 99.91%를 무엇으로 재현할지(주기·프로세스·엑셀/이카운트)"],
      ["연봉·퇴사 사유", "직전 4,500 vs 물류 예산[대표 확정] — 선고지. 에스티엘 퇴사(2025.10) 이후 경위 확인"],
    ],
  },
  "황현수": {
    verdict: "판정 기준: ①하트피스 실무 깊이(이카운트·B2B·3PL이 '본인 손'인가) + ②연봉 기대 정렬 — 통과 시 실무 정합 추천. 물류 순수 연차가 얕아 실물 검증이 관문",
    points: [
      ["🔑 이카운트 실물", "B2B 주문 접수→출고→월 2회 재고 실사를 하루 일과로 걸어가게 하라 — 우리 ERP 그대로라 온보딩 비용 0인지 확인"],
      ["🔑 연봉 기대", "희망 '회사내규'인데 핫시즈너(생산직) 기재 연봉이 6,000 — 물류 전환 후 기대치가 우리 레인지와 맞는지 최초반 숫자로"],
      ["3PL·배차", "3PL 입출고 조율·거래처 납기 배차의 실물 사례 — SKU 350종 오입출 수정 경험"],
      ["경력 전환 스토리", "승마→주방→생산→물류 — 전환 사유의 일관성과 물류 정착 의지"],
    ],
  },
  "한선진": {
    verdict: "판정 기준: ①브이플랫폼 2개월 퇴사 사유 납득(최초반) + ②이카운트 구축·유효기간 관리의 실물 — 통과 시 '시스템 구축형' 최우선 추천",
    points: [
      ["🔑 2개월 퇴사(최초반)", "직전 회사 2개월 — '구매/SCM 성장 위해'라는 기재 사유의 실체. 납득 안 되면 근속 리스크로 판정"],
      ["🔑 이카운트 구축력", "리마코리아 수기→ERP 전환을 직접(세팅·운영 기준·교육) — 무엇을 어떤 순서로 세팅했는지 워크스루. 우리 이카운트 고도화에 즉시 이식 가능한지"],
      ["유효기간·LOT 이식", "의료기기 유효기간·LOT 관리 → 식품 유통기한·선입선출 설계로 전환 가능한가"],
      ["위탁재고·B2B", "3PL 위탁재고 운영+공급내역보고·월 마감 — 우리 약국 B2B 납품 문법과 정합"],
    ],
  },
  "강한별": {
    verdict: "판정 기준: ①최근 3연속 단기(7·11·8개월) 사유 납득 + ②건기식 SCM·쿠팡 밀크런의 '본인 손' — 통과 시 예산·정합 최적 카드",
    points: [
      ["🔑 근속(최초반)", "유엠아키 7개월·옵티머스 11개월·리샘 8개월 — 회사별 사유를 하나씩. 패턴 자각 없으면 Red Flag"],
      ["🔑 건기식 SCM 실물", "옵티머스에서 건강기능식품 SCM — 3PL 핸들링·B2B 발주·현장 이슈 컨트롤을 실사례로. 우리 카테고리 직경험의 깊이 확인"],
      ["쿠팡 밀크런", "리샘에서 밀크런 납품 세팅 — 우리 쿠팡 확장 시 즉시 가치. 세팅 과정 워크스루"],
  ...
  "김소영": {
    ...
    points: [
      ["🔑 경력 구성 확인 (최초반)", "잡코리아 요약은 '뉴트리엄(캐나다 건기식) 3.8y'인데 노션 포트폴리오는 길재소프트웨어·차트·매드스퀘어·브릿지코드 국내 4개사 — 타임라인을 연도별로 걸어가게 하라. 설명이 안 맞으면 정직성 이슈"],
      ["🔑 성과 규모 갭", "포트폴리오 수치가 소형(릴스 6.3만·구독 800명·주간 조회 3,100) — 월 광고비 규모를 직접 물어라. 우리 월 1,000만+ 증액 국면과의 갭을 본인이 인지하는가"],
      ["✅ 접점 2개", "브릿지코드-택슬리=세무상담 플랫폼 퍼널(우리 상담약국 모델과 동일 문법) + Higgsfield AI·AI 콘텐츠 제작(우리 스택 일치) — 이 둘을 깊게 파라"],
      ["연봉 미기재", "'면접 후 결정' — 최초반 선고지(상한 5,500)로 숫자를 먼저 받아라. ✅ 공고 반복 스크랩=동기 강점"],
    ],
  },
};
// ─── 08.26 면접자 시드 (앱 로드 시 없으면 자동 추가 — 방장 push에도 유지) ─────────
const SEED_CANDIDATES = [
  {
    id: "seed_jyc_0826", positionId: "p_conv", name: "정유철", age: 40, channel: "사람인", stage: "면접",
    resume: "[08.26 면접 확정 — 사람인 지원(08.21)]\n총 경력 11년 1개월 · 디자인+퍼포먼스 겸장 팀장 · 서울 강남구 개포동\n직전 연봉 7,000 / 희망 6,000~7,000 (⚠ 상한 5,500 초과 — 최초반 선고지)\n\n[핵심 경력]\n㈜동일제약 커머스사업부 마케팅 팀장 1년10개월(2024.05~2026.02) — 스킨케어 브랜드 운영, META/GFA/SA/DA 직접 운영, 신제품 기획·디자인, IMC\n㈜커버프렌즈 그로스팀장 2년9개월 — 제품·마케팅·디자인 총괄, 월매출 1억 커머스\n그 외 유니박(8개월)·웨이크(8개월)·365위더스·로커스·아웃피터스 — 디자인팀장 트랙\n\n[포트폴리오 https://jeongyucheol.github.io/performance/]\nCOSWORKER(뷰티): 매출 0→연 5억, ROAS 420%, CPA -40%, 소재 A/B 14개 제품, 3D 콘텐츠 제작\nFORBIDDEN EDEN(리빙): Max ROAS 580%, 일평균 1,000만원, 올리브영 입점\nGREEDILOUS(패션): Max ROAS 700%\n\n[학력] 영산대 영어학(4.3) · 부경대 시각디자인 편입/중퇴 · 웹디자인기능사 · 국제타이포전 수상",
    files: [], fileNames: ["마케터정유철_8.26.pdf"],
  },
  {
    id: "seed_wti_0826", positionId: "p_conv", name: "왕태일", age: 43, channel: "기타", stage: "면접",
    resume: "[08.26 면접 확정 — 네이버웍스 수신]\n총 경력 18년 · 브랜드·비즈니스 디렉터(본부장·창업·사업총괄 트랙) · 하남 미사\n직전·희망 연봉 8,700 (⚠ 상한 5,500과 3,200 갭 — 총괄 트랙 가치 vs 비용 판단 면접)\n\n[핵심 경력]\n㈜비욘드허니컴 마케팅 스페셜리스트 재직중(2026.05~) — AI 그릴 GRILL X B2B 디맨드젠, Google·Meta·GA4·CRM 퍼널, 월 400건+ 리드\n㈜이너스커뮤니티 브랜드사업 본부장 2년7개월 — 도드람 캔돈 제품개발 PM(iF디자인 수상), 인스탁스 WIDE EVO 론칭 140%, 코렐 매출 2배, AEO/GEO 솔루션 Team HAI 론칭\n더워터멜론 7개월 — BE-KIND 한국 론칭, 대상웰라이프 아르포텐(건기식) 컨설팅\n왕조시대 컴퍼니 창업 1년3개월 — JM솔루션 앰플 론칭 120%·올리브영\n㈜도브투래빗 본부장 9년9개월 — 마케팅 조직 35명·200억 운영, 올리브영 온드미디어 자산화, FROMST D2C ROAS 300%+\n\n[수상] ICT AWARD KOREA 2026 GRAND PRIX(Team HAI)·iF디자인·디지털광고대상 마케팅대상 등\n[학력] 서울디지털대 디지털디자인+마케팅 복수(4.03)",
    files: [], fileNames: ["왕태일(1).pdf", "왕태일 포트폴리오(1).pdf"],
  },
];
const _UNUSED_FOCUS_TAIL = {
};
// ─── 08.31주 면접자 시드 (이시라·김남수 — 1회 자동 병합) ─────────
const SEED_CANDIDATES_2 = [
  {
    id: "seed_lsr_0901", positionId: "p_conv", name: "이시라", age: 30, channel: "기타", stage: "면접",
    resume: "[면접 확정(이번 주) — 잡코리아 헤드헌팅·위드컴퍼니 15%]\n총 5년 7개월 · 블렌디드 4년 5개월(코어뉴트리션 건강식품 BM) · 2026.07 퇴사\n희망 5,500(예산 정합) · 2주 내 입사 · 강동구\nMeta·네이버·카카오·쿠팡 직접 운영(월 최대 2.7억, ROAS 400%), Cafe24 자사몰, 카카오채널 2만→5만, 액상 비오틴 신제품 E2E, NS홈쇼핑 런칭 총괄\n상세는 앱 내장 경력카드·중점포인트 참조",
    files: [], fileNames: ["이시라.pdf", "이시라 포트폴리오.pdf"],
  },
  {
    id: "seed_kns_0901", positionId: "p_conv", name: "김남수", age: 39, channel: "기타", stage: "면접",
    resume: "[면접 확정(이번 주) — 잡코리아 헤드헌팅·피플케어코리아 20%]\n총 16년 · 건기식/식품 D2C 총괄 3년 5개월 + 창업 4년 6개월 + 교보라이프플래닛 그로스 3년 7개월\n현 8,500/희망 9,500 ⚠(선고지 필수)\n건기식 신제품 11종·심의 메시지 매트릭스(센트럴팜) / 식품 자사몰 0→1: 3개월 월 400만→3억+, ROAS 300%+ 직접 운영(교동식품) / 진단→상담→계약 퍼널(교보 — 우리 모델 동일 문법 자기 명시) / Claude Code·Codex 자동화\n상세는 앱 내장 경력카드·중점포인트 참조",
    files: [], fileNames: ["김남수_입사지원서_브랜드총괄마케터.pdf", "김남수_포트폴리오_브랜드총괄마케터.pdf"],
  },
];
// ─── 08.31 추가 면접자 시드 (김소영·황유정 — 1회 자동 병합) ─────────
const SEED_CANDIDATES_3 = [
  {
    id: "seed_hyj_0901", positionId: "p_conv", name: "황유정", age: 34, channel: "기타", stage: "면접",
    resume: "[면접 확정 — 잡코리아 헤드헌팅·JnCHR 조천수 20%]\n총 10년 2개월 · 에이치데일리(혈당·체중 건강식품) 마케팅 과장 재직중 1년 7개월\n현 4,999(고정급)/희망 협의 — 예산 정합 ✅ · 구로구 신도림\n생성형 AI 숏폼 광고 제작 프로세스 구축, Meta 소재 기획·세팅·분석, 신제품 론칭 3건(레몬애사비·톡스핏·하이아), 광주요 자사몰 ROAS 1,000%+\n⚠ 퇴사 사유 대부분 회사 사정(폐업·팀해체·계약만료) · 매체 볼륨 미기재\n상세는 앱 내장 경력카드·중점포인트 참조",
    files: [], fileNames: ["황유정_(주)큐라엘_브랜드 총괄 인하우스 마케터_JnCHR 조천수(260827).pdf"],
  },
  {
    id: "seed_ksy_0901", positionId: "p_conv", name: "김소영", age: 32, channel: "잡코리아", stage: "면접",
    resume: "[면접 확정 — 잡코리아 '건기식 콘텐츠 마케터' 공고 지원자(스크리닝 s01, 1순위 A-)]\n뉴트리엄(캐나다·건기식) 3년 8개월 · 연봉 '면접 후 결정'(⚠ 최초반 선고지 필수)\n✅ 우리 공고 반복 스크랩 = 관심 지속\n⚠ 이력서 상세 미확보 — 면접 전 잡코리아 지원자 페이지에서 PDF 확보 권장\n관문: 국내 매체(네이버·카카오·쿠팡) 적응 + 뉴트리엄 업무 실체",
    files: [], fileNames: [],
  },
];
// ─── 09.01 물류 면접자 시드 (이재혁·이재희 — 포지션 포함 1회 자동 병합) ─────────
const SEED_POSITION_LOGI = { id: "p_logi", name: "⑤ 물류 운영 담당자 (인하우스 약국+B2B)", colorIdx: 3 };
const SEED_CANDIDATES_4 = [
  {
    id: "seed_ljh2_0901", positionId: "p_logi", name: "이재혁", age: 31, channel: "사람인", stage: "면접",
    resume: "[물류 면접 확정(일시 미정) — 사람인 물류창고 공고 1차면접]\n총 8년 6개월 · 세종사이버대 유통물류학과 · ⚠ 용인 기흥 거주(노원 통근 확인 필수)\n메이크스타 재고관리파트 대리/파트장 2y2m — SKU 7,000 Loc 체계 구축, 자체 WMS 기능 개발 기획, SOP 작성, 물류센터 확장 이전(1,100→4,800셀) 주도, 지게차 6대 관리\n현 4,050/희망 4,000~5,000 (⚠ 물류 예산 레인지 대표 확정 필요)\n상세는 앱 내장 경력카드·중점포인트 참조",
    files: [], fileNames: [],
  },
  {
    id: "seed_ljh1_0901", positionId: "p_logi", name: "이재희", age: 30, channel: "사람인", stage: "면접",
    resume: "[물류 면접 확정(일시 미정) — 사람인 노원구 유통물류 공고 서류→승격]\n총 6년 11개월 · 용산구 · 화장품·명품 물류 파트장\n에스티엘 2y — 화장품 물류 전반(SKU·유통기한·LOT), 재고일치 99.91%·오배송 0.07%, Qoo10 메가와리 일 20만 건 출고 / 케이엘엔 2y11m — 몽클레르·스톤아일랜드, 백화점 30곳 B2B 납품 정시율 99%, 김포→인천 센터 이관\n직전 4,500/희망 내규\n상세는 앱 내장 경력카드·중점포인트 참조",
    files: [], fileNames: [],
  },
];
// ─── 09.07 물류 면접자 시드 (황현수·한선진·강한별) ─────────
const SEED_CANDIDATES_5 = [
  {
    id: "seed_hhs_0907", positionId: "p_logi", name: "황현수", age: 35, channel: "사람인", stage: "면접",
    resume: "[물류 면접 9/7(월) 11:00]\n총 14y8m(물류 순수 ~2.5y) · 성북구\n하트피스 물류팀 대리 1y9m — 식품공장 3브랜드, 이카운트 ERP B2B 주문·출고, SKU 350종, 3PL 조율, 월 2회 재고 실사\n희망 '회사내규'(⚠선고지 필수 — 직전 생산직 기재 6,000)\n상세는 앱 내장 경력카드",
    files: [], fileNames: ["황현수_이력서.pdf"],
  },
  {
    id: "seed_hsj_0907", positionId: "p_logi", name: "한선진", age: 34, channel: "사람인", stage: "면접",
    resume: "[물류 면접 9/7(월) 12:00]\n총 8y11m · 중랑구 · 직전 4,100/희망 4,000~5,000\n리마코리아 물류과장 4y10m — 의료기기 수입 물류, LOT·유효기간·위탁재고, 수기→이카운트 ERP 직접 구축(세팅·기준·교육)\n⚠직전 브이플랫폼 2개월 초단기 — 최초반 확인\n상세는 앱 내장 경력카드",
    files: [], fileNames: ["한선진_이력서.pdf", "물류 직무 포트폴리오.pdf(사람인 별첨)"],
  },
  {
...
export default function HireL() {
  ...
  // 08.26 면접자(정유철·왕태일) 자동 추가 — 1회만 병합, 이후 삭제해도 되살리지 않음
  useEffect(() => {
    try {
      if (localStorage.getItem("seed_0826_done") === "1") return;
      setCandidates(p => {
        const missing = SEED_CANDIDATES.filter(s => !p.some(c => c && (c.name || "").trim() === s.name));
        return missing.length ? [...p, ...missing] : p;
      });
      localStorage.setItem("seed_0826_done", "1");
    } catch (e) {}
  }, []);

  // 08.31주 면접자(이시라·김남수) 자동 추가 — 1회만 병합
  useEffect(() => {
    try {
      if (localStorage.getItem("seed_0901_done") === "1") return;
      setCandidates(p => {
        const missing = SEED_CANDIDATES_2.filter(s => !p.some(c => c && (c.name || "").trim() === s.name));
        return missing.length ? [...p, ...missing] : p;
      });
      localStorage.setItem("seed_0901_done", "1");
    } catch (e) {}
  }, []);
  ...
  // 08.31 추가 면접자(김소영·황유정) 자동 추가 — 1회만 병합
  useEffect(() => {
    try {
      if (localStorage.getItem("seed_0901b_done") === "1") return;
      setCandidates(p => {
        const missing = SEED_CANDIDATES_3.filter(s => !p.some(c => c && (c.name || "").trim() === s.name));
        return missing.length ? [...p, ...missing] : p;
      });
      localStorage.setItem("seed_0901b_done", "1");
    } catch (e) {}
  }, []);

  // 09.07 물류 면접자(황현수·한선진·강한별) 자동 추가 — 1회만 병합
  useEffect(() => {
    try {
      if (localStorage.getItem("seed_logi_0907_done") === "1") return;
      setCandidates(p => {
        const missing = SEED_CANDIDATES_5.filter(s => !p.some(c => c && (c.name || "").trim() === s.name));
        return missing.length ? [...p, ...missing] : p;
      });
  ...
  useEffect(() => {
    try {
      if (localStorage.getItem("seed_logi_0901_done") === "1") return;
      setPositions(p => p.some(x => x && x.id === "p_logi") ? p : [...p, SEED_POSITION_LOGI]);
      setCandidates(p => {
        const missing = SEED_CANDIDATES_4.filter(s => !p.some(c => c && (c.name || "").trim() === s.name));
        return missing.length ? [...p, ...missing] : p;
      });
      localStorage.setItem("seed_logi_0901_done", "1");
    } catch (e) {}
  }, []);
