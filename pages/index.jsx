...
const CAREER_BUILTIN = {
  ...
  "김소영": {
    ...
    note: "🗓 면접 9/1(월) 7시(⚠ 오전/오후 유해인 확인) · 연봉 '면접 후 결정' — 최초반 선고지 필수. ✅ 공고 반복 스크랩=동기, AI 콘텐츠 제작·Higgsfield 사용(우리 스택과 일치). ⚠ 포트폴리오 성과 규모가 소형(릴스 6.3만 조회·구독 800명·A/B 4배) — 월 1,000만 광고비 국면과의 갭 검증",
  },
  "왕태일": {
...
const FOCUS_BUILTIN = {
  ...
  "박현철": {
    verdict: "판정 기준: 연봉 수용 + 실무 선행 수용 시 추천 — 기대치는 높게(김동현), 단 '직접 수행 비중'이 관문 (08.21 협의 반영)",
    points: [
