...
const CAREER_BUILTIN = {
  ...
  "김남수": {
    ...
    note: "🗓 면접 9/2(화) 16:00 · ⚠ 현재 8,500/희망 9,500 — 총괄 예산 결정 필요(최초반 선고지). AI: Claude Code·Codex 자동화 파이프라인 직접 운영. 지원서에서 큐라엘 모델('제품·정보·상담 연결')을 정확히 명시한 유일한 후보",
  },
  "황유정": {
  ...
  "김소영": {
    ...
    note: "🗓 면접 9/1(월) 19:00 확정 · 연봉 '면접 후 결정' — 최초반 선고지 필수. ✅ 공고 반복 스크랩=동기, AI 콘텐츠 제작·Higgsfield 사용(우리 스택과 일치). ⚠ 포트폴리오 성과 규모가 소형(릴스 6.3만 조회·구독 800명·A/B 4배) — 월 1,000만 광고비 국면과의 갭 검증",
  },
  "왕태일": {
...
const FOCUS_BUILTIN = {
  ...
  "박현철": {
    verdict: "⚠ 08.31 현재 재지원 후 연락 두절 — 2차 일정 미확정. 리마인드 1회 후 무응답이면 종결(추격 금지). 판정 기준: 연봉 수용 + 실무 선행 수용 시 추천, '직접 수행 비중'이 관문",
    points: [
