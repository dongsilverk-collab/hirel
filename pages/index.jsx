...
【면접 질문 10개 생성 규칙】
반드시 아래 구성으로 정확히 10개 생성:
- 인성/컬쳐핏 질문 3개: 큐라엘 문화와 가치관 적합성 확인
- 직무 역량 질문 5개: 해당 포지션 실무 능력 검증
- 회사 미래/방향성 질문 2개: 암환자 시장, 회사 성장 방향에 대한 생각

순수 JSON으로만 응답 (마크다운 없이):
{"totalScore":숫자(0-100),"scores":{"experienceMatch":숫자(0-100),"cultureFit":숫자(0-100),"skillKeywords":숫자(0-100),"stability":숫자(0-100)},"verdict":"추천"|"검토필요"|"부적합","strengths":["강점1","강점2","강점3"],"weaknesses":["약점1","약점2"],"keywords":[{"word":"키워드","type":"positive"|"negative"|"neutral"}],"interviewQuestions":{"culture":["컬쳐핏질문1","컬쳐핏질문2","컬쳐핏질문3"],"skill":["직무질문1","직무질문2","직무질문3","직무질문4","직무질문5"],"future":["미래질문1","미래질문2"]},"summary":"2-3문장 요약"}`;
...
async function scoreInterview(jd, name, transcript, questions) {
  const allQ = questions ? [...(questions.culture||[]),...(questions.skill||[]),...(questions.future||[])] : [];
